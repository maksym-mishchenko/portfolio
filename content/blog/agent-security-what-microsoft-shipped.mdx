...
When building [OpenClaw](https://github.com/maksym-mishchenko/openclaw-dashboard) (autonomous engineering manager), we hit this exact gap. Entra provides the identity foundation (who is this agent?), but does not prevent a compromised agent from calling destructive tools.
