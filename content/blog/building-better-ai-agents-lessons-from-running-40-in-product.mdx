...
<Timeline events="[{\"label\":\"Error occurs\",\"description\":\"An agent acts unexpectedly\",\"icon\":\"❌\"},{\"label\":\"Check logs\",\"description\":\"Trace the agent's actions\",\"icon\":\"🔍\"},{\"label\":\"Fix issue\",\"description\":\"Update code or constraints\",\"icon\":\"✅\"}]" />
